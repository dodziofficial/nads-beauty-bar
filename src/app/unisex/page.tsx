...
export default async function UnisexPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <Header activeGender="unisex" />

      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8 text-gray-900">🔄 Unisex Collection</h1>
            ...
            return (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600 capitalize mt-1">Unisex</p>
                </div>
              </Link>
            )
          })}
